    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border/50 hover:border-primary/30 transition-all duration-500">
            <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl border border-border/50 hover:border-primary/30 transition-all duration-500">
              <Image
                src="/smiling-dental-assistant.png"
                alt="AI Assistant"
                fill
